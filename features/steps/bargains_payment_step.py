...
import logging
from behave import *
from apps.models import Activity, Merchant, User, Bargains
...
# @when("用户'{username}'参加最近添加的砍价支付活动")
# def step_impl(context, username):
#     with context.app.app_context():
